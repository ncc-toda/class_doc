// 参考: https://zenn.dev/ks0318/articles/b8eb2c9396f9cb
...
const mdcConfigurations = [
  ...
  {
    output: ".cursor/rules/001_development_common.mdc",
    sourceDir: "rules/development/common",
    header: "", // もしコメントとか入れたければ
    filePattern: "*.md",
    sortBy: "name"
  },
  // 一旦 doc 系は 01X にしておく。
  {
    output: ".cursor/rules/010_doc_concepts.mdc",
    sourceDir: "rules/doc",
    header: "", // もしコメントとか入れたければ
    filePattern: "*.md",
    sortBy: "name"
